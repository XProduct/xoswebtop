...
// Define the full path to your folder from root 
    ...
    if($file == "." || $file == ".." || $file == "index.php" || $file == "music") 
		...
		if($ext == ".jpg" || $ext == ".jpeg" || $ext == ".gif" || $ext == ".png" || $ext == ".bmp" || $ext == ".psd" || $ext == ".pxd") {
			echo("&nbsp;&nbsp;&nbsp;<a href=\"#\" onClick=\"pixlr.edit({image:'http://xos.xproduct.net/files/uploads/$session->username/$file', title:'$file', service:'editor', exit:'http://xos.xproduct.net" . $_SERVER['PHP_SELF'] . "'});\" oncontextmenu=\"showDiv('contextDismiss'); contextMenu(event, 'menu$i'); return false;\">$file</a><br>");
			...
			echo("<div><hr></div>");
			echo("<div class=\"contextEntry\" onClick=\"pixlr.edit({image:'http://xos.xproduct.net/files/uploads/$session->username/$file', title:'$file', service:'express', exit:'http://xos.xproduct.net" . $_SERVER['PHP_SELF'] . "'});\">&nbsp;&nbsp;&nbsp;Express Edit</div>");
			echo("<div class=\"contextEntry\" onClick=\"pixlr.edit({image:'http://xos.xproduct.net/files/uploads/$session->username/$file', title:'$file', service:'editor', exit:'http://xos.xproduct.net" . $_SERVER['PHP_SELF'] . "'});\">&nbsp;&nbsp;&nbsp;Full Editor</div>");
			echo("<div><hr></div>");
